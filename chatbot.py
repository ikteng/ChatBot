...
save_dir = os.path.join("Chatbot\data", "save")
...
def evaluate(encoder, decoder, searcher, voc, sentence, max_length=MAX_LENGTH):
    ...
    input_batch = input_batch.to(device="cpu")
    # move lengths to CPU
    lengths = lengths.to("cpu")
...
# If CUDA is unavailable, move models and optimizers to CPU
